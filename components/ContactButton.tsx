  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="bg-white rounded-3xl p-8 max-w-lg w-full mx-4 shadow-2xl border border-gray-100 relative overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <h2 className="text-3xl font-bold text-gray-800 mb-3 bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent">
                  Contact Us
                </h2>
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid gap-3">
                    {phoneNumbers.map((number, index) => (
                      <a
                        ...
                        className="group relative overflow-hidden bg-gradient-to-r from-red-50 via-red-100 to-pink-50 hover:from-red-100 hover:via-red-200 hover:to-pink-100 p-5 rounded-2xl border-2 border-red-200 hover:border-red-300 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                        onClick={(e) => e.stopPropagation()}
                      >
                        <div className="flex items-center justify-between relative z-10">
                          <div className="flex items-center">
                            <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
                              <span className="text-white font-bold text-lg">
                                📞
                              </span>
                            </div>
                            <div>
                              <div className="font-bold text-xl text-gray-800 group-hover:text-red-800 transition-colors">
                                {number}
                              </div>
                ...
                <div>
                  ...
                  <a
                    ...
                    className="group relative overflow-hidden bg-gradient-to-r from-pink-50 via-purple-50 to-pink-100 hover:from-pink-100 hover:via-purple-100 hover:to-pink-200 p-5 rounded-2xl border-2 border-pink-200 hover:border-pink-300 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 block"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="flex items-center justify-between relative z-10">
                      <div className="flex items-center">
                        <div className="w-12 h-12 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
